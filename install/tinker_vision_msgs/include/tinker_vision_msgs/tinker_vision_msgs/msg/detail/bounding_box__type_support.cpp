...
{
  new (message_memory) tinker_vision_msgs::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tinker_vision_msgs::msg::BoundingBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[4] = {
  {
    ...
    offsetof(tinker_vision_msgs::msg::BoundingBox, xmin),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tinker_vision_msgs::msg::BoundingBox, ymin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tinker_vision_msgs::msg::BoundingBox, xmax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tinker_vision_msgs::msg::BoundingBox, ymax),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox_message_members = {
  ...
  4,  // number of fields
  sizeof(tinker_vision_msgs::msg::BoundingBox),
...
get_message_type_support_handle<tinker_vision_msgs::msg::BoundingBox>()
{
  return &::tinker_vision_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tinker_vision_msgs, msg, BoundingBox)() {
  return &::tinker_vision_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
