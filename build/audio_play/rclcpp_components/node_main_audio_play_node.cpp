...
#define NODE_MAIN_LOGGER_NAME "audio_play_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaudio_play.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<audio_play::AudioPlayNode>";
