...
#ifndef TINKER_ARM_MSGS__SRV__DETAIL__ROBOTIQ__FUNCTIONS_H_
#define TINKER_ARM_MSGS__SRV__DETAIL__ROBOTIQ__FUNCTIONS_H_
...
/// Initialize srv/Robotiq message.
/**
...
/// Create srv/Robotiq message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tinker_arm_msgs__srv__Robotiq_Request__init().
...
/// Destroy srv/Robotiq message.
/**
 * It calls
 * tinker_arm_msgs__srv__Robotiq_Request__fini()
...
/// Check for srv/Robotiq message equality.
/**
...
/// Initialize array of srv/Robotiq messages.
/**
...
/// Finalize array of srv/Robotiq messages.
/**
 * It calls
 * tinker_arm_msgs__srv__Robotiq_Request__fini()
...
/// Create array of srv/Robotiq messages.
/**
 * It allocates the memory for the array and calls
 * tinker_arm_msgs__srv__Robotiq_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Robotiq messages.
/**
 * It calls
 * tinker_arm_msgs__srv__Robotiq_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Robotiq message array equality.
/**
...
/// Copy an array of srv/Robotiq messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tinker_arm_msgs__srv__Robotiq_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tinker_arm_msgs
...
/**
 * It calls
 * tinker_arm_msgs__srv__Robotiq_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tinker_arm_msgs
...
/**
 * It allocates the memory for the array and calls
 * tinker_arm_msgs__srv__Robotiq_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tinker_arm_msgs
...
/**
 * It calls
 * tinker_arm_msgs__srv__Robotiq_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TINKER_ARM_MSGS__SRV__DETAIL__ROBOTIQ__FUNCTIONS_H_
