...
#define NODE_MAIN_LOGGER_NAME "audio_capture_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaudio_capture.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<audio_capture::AudioCaptureNode>";
