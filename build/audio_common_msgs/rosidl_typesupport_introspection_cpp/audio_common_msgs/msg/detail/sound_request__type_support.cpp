...
{
  new (message_memory) audio_common_msgs::msg::SoundRequest(_init);
}

void SoundRequest_fini_function(void * message_memory)
{
  auto typed_message = static_cast<audio_common_msgs::msg::SoundRequest *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SoundRequest_message_member_array[5] = {
  {
    ...
    offsetof(audio_common_msgs::msg::SoundRequest, sound),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(audio_common_msgs::msg::SoundRequest, command),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(audio_common_msgs::msg::SoundRequest, volume),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(audio_common_msgs::msg::SoundRequest, arg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(audio_common_msgs::msg::SoundRequest, arg2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SoundRequest_message_members = {
  ...
  5,  // number of fields
  sizeof(audio_common_msgs::msg::SoundRequest),
...
{
  return &::audio_common_msgs::msg::rosidl_typesupport_introspection_cpp::SoundRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, audio_common_msgs, msg, SoundRequest)() {
  return &::audio_common_msgs::msg::rosidl_typesupport_introspection_cpp::SoundRequest_message_type_support_handle;
}
