    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_Goal')
            logger.debug(
...
class SoundRequest_Goal(metaclass=Metaclass_SoundRequest_Goal):
    ...
    _fields_and_field_types = {
        'sound_request': 'audio_common_msgs/SoundRequest',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['audio_common_msgs', 'msg'], 'SoundRequest'),  # noqa: E501
    )
...
class Metaclass_SoundRequest_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_SoundRequest_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_SoundRequest_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from audio_common_msgs.action import SoundRequest
...
class SoundRequest_SendGoal_Request(metaclass=Metaclass_SoundRequest_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'audio_common_msgs/SoundRequest_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['audio_common_msgs', 'action'], 'SoundRequest_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from audio_common_msgs.action._sound_request import SoundRequest_Goal
...
class Metaclass_SoundRequest_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from audio_common_msgs.action import _sound_request
...
class SoundRequest_SendGoal(metaclass=Metaclass_SoundRequest_SendGoal):
    from audio_common_msgs.action._sound_request import SoundRequest_SendGoal_Request as Request
    from audio_common_msgs.action._sound_request import SoundRequest_SendGoal_Response as Response
...
class SoundRequest_GetResult_Response(metaclass=Metaclass_SoundRequest_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'audio_common_msgs/SoundRequest_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['audio_common_msgs', 'action'], 'SoundRequest_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from audio_common_msgs.action._sound_request import SoundRequest_Result
...
class Metaclass_SoundRequest_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SoundRequest_GetResult(metaclass=Metaclass_SoundRequest_GetResult):
    from audio_common_msgs.action._sound_request import SoundRequest_GetResult_Request as Request
    from audio_common_msgs.action._sound_request import SoundRequest_GetResult_Response as Response
...
class Metaclass_SoundRequest_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SoundRequest_FeedbackMessage(metaclass=Metaclass_SoundRequest_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'audio_common_msgs/SoundRequest_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['audio_common_msgs', 'action'], 'SoundRequest_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from audio_common_msgs.action._sound_request import SoundRequest_Feedback
...
class Metaclass_SoundRequest(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'audio_common_msgs.action.SoundRequest')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class SoundRequest(metaclass=Metaclass_SoundRequest):
    ...
    from audio_common_msgs.action._sound_request import SoundRequest_Goal as Goal
    # The result message defined in the action definition.
    from audio_common_msgs.action._sound_request import SoundRequest_Result as Result
    # The feedback message defined in the action definition.
    from audio_common_msgs.action._sound_request import SoundRequest_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from audio_common_msgs.action._sound_request import SoundRequest_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from audio_common_msgs.action._sound_request import SoundRequest_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from audio_common_msgs.action._sound_request import SoundRequest_FeedbackMessage as FeedbackMessage
