...
static const _SoundRequest_type_support_symbol_names_t _SoundRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, audio_common_msgs, msg, SoundRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, audio_common_msgs, msg, SoundRequest)),
  }
};
...
{
  return &::audio_common_msgs::msg::rosidl_typesupport_cpp::SoundRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, audio_common_msgs, msg, SoundRequest)() {
  return get_message_type_support_handle<audio_common_msgs::msg::SoundRequest>();
}
