...
#include "tinker_vision_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox__ros_msg_type = tinker_vision_msgs__msg__BoundingBox;
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tinker_vision_msgs__msg__BoundingBox(
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tinker_vision_msgs__msg__BoundingBox(
