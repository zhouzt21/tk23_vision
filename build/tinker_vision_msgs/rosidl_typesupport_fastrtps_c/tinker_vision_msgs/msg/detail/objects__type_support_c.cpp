...
#include "tinker_vision_msgs/msg/detail/objects__rosidl_typesupport_fastrtps_c.h"
...
using _Objects__ros_msg_type = tinker_vision_msgs__msg__Objects;
...
size_t get_serialized_size_tinker_vision_msgs__msg__Objects(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Objects__ros_msg_type * ros_message = static_cast<const _Objects__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Objects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tinker_vision_msgs__msg__Objects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tinker_vision_msgs
size_t max_serialized_size_tinker_vision_msgs__msg__Objects(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Objects__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tinker_vision_msgs__msg__Objects(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tinker_vision_msgs, msg, Objects)() {
