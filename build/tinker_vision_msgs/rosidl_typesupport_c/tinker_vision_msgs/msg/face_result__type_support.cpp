...
static const _FaceResult_type_support_symbol_names_t _FaceResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tinker_vision_msgs, msg, FaceResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tinker_vision_msgs, msg, FaceResult)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tinker_vision_msgs, msg, FaceResult)() {
  return &::tinker_vision_msgs::msg::rosidl_typesupport_c::FaceResult_message_type_support_handle;
}
