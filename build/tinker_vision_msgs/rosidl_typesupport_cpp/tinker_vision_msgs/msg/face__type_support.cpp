...
static const _Face_type_support_symbol_names_t _Face_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tinker_vision_msgs, msg, Face)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tinker_vision_msgs, msg, Face)),
  }
};
...
{
  return &::tinker_vision_msgs::msg::rosidl_typesupport_cpp::Face_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tinker_vision_msgs, msg, Face)() {
  return get_message_type_support_handle<tinker_vision_msgs::msg::Face>();
}
