...
#include "tinker_vision_msgs/msg/detail/face_result__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tinker_vision_msgs::msg::Face &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const tinker_vision_msgs::msg::FaceResult & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tinker_vision_msgs::msg::FaceResult & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: faces
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        tinker_vision_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Face(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const tinker_vision_msgs::msg::FaceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tinker_vision_msgs::msg::FaceResult *>(
    untyped_ros_message);
...
static size_t _FaceResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaceResult(full_bounded, is_plain, 0);
...
{
  return &tinker_vision_msgs::msg::typesupport_fastrtps_cpp::_FaceResult__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tinker_vision_msgs, msg, FaceResult)() {
  return &tinker_vision_msgs::msg::typesupport_fastrtps_cpp::_FaceResult__handle;
}
