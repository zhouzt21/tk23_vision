...
#include "tinker_vision_msgs/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tinker_vision_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tinker_vision_msgs::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &tinker_vision_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
